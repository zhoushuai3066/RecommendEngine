...
import com.busap.map.RecommendedTableReadMap;
import com.mongodb.hadoop.MongoInputFormat;
import com.mongodb.hadoop.util.MongoConfigUtil;



public class GenerateRecommendedDataSourceJob {
...
//		   System.out.println(collection.count());
		...
		job.setJarByClass(GenerateRecommendedDataSourceJob.class);
		...
		//设置map
		job.setMapperClass(RecommendedTableReadMap.class);
